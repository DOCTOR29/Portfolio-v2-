...
import { ConfettiBtn } from "./ConfettiButton";
...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background: " rgb(25,16,0)",
        backgroundColor:
          "linear-gradient(90deg, rgba(29,22,0,1) 0%, rgba(35,29,12,1) 100%)",
      }}
    > 
             ...
             <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#2e2810]"
                  >
                    {item}
                  </span>
                ))}
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#2e2810]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#2e2810]"></span>
