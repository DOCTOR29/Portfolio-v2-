      ...
      <footer className='w-full mb-[100px] md:mb-5 pb-10' id='contact'>
          ...
          <div className='flex flex-col items-center'>
              <h1 className='heading lg:max-w-[45vw]'>
                  Ready to take <span className='text-yellow-500'>your</span> outside digital presence to the next level?
              </h1>
              <p className='text-white-200 md:mt-10 my-5 text-center'>Reach out to me today and let&apos;s discuss how I can help you achieve your goals.</p>
              <a href='mailto:naveedislam545@gmail.com'>
                  <MagicButton
                   position='right'
          ...
          <div className='flex mt-16 md:flex-row gap-5 flex-col justify-between items-center'>
              <p className='md:text-base text-sm md:font-normal font-light'>Copyright © {new Date().getFullYear()} Naveed
